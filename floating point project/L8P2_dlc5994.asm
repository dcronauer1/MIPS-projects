...
promptEnterXNums: .asciiz "How many floats? (2-20):"
invalid: .asciiz "Invalid Num\n"
...
main:
  li $v0,4
  la $a0,promptEnterXNums
  syscall 		#print "How many floats? (2-20):"
  li $v0,5
  syscall		#input int
  bgtu $v0,20,mainInvalid
  blt $v0,2,mainInvalid#2<=num<=20
  move $s0,$v0
...
#input $a1 - address of array
  ...
  sfForLoop1:
    ...
    sfForLoop2:
      bge $t2,$t4,sfEndForLoop2 #j>=n-i, end for2
